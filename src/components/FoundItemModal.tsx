...
export const foundItemMessage = (
    ...
    <ul className="list">{listItems}</ul> */}
		<p>
			...
			<a href='mailto:cucinfodesk@andrew.cmu.edu' className='link-accent link'>
...
export const lostItemMessage = (
	<>
		<p>
			...
			<a href='mailto:lost-and-found@cmu.edu' className='link-accent link'>
				lost-and-found@cmu.edu
			</a>
			. Note that we do not actively cross-reference reported lost items with
			current lost and found inventory. Instead, we use the information
			submitted in special cases should we need to identify an item.
		</p>
	</>
);
